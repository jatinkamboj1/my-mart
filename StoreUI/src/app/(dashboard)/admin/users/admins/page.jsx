...
import { allAdmins, deleteUser } from "@/app/api/users";
...
const Page = () => {
  ...
  const fetchCustomers = async (token, page = 1, filter={name: null, role: "ADMIN"}) => {
    try {
      ...
      <div className="py-5">
        <div className="row g-4 align-items-center">
          ...
          <div className="col-auto d-flex">
            <a href="/admin/users/admins/new" className="btn btn-primary">
              New Customer
            </a>
          </div>
        </div>
                    ...
                    <tr key={`customer-${index}`}>
                      <td className="sorting_1">
                        <div className="d-flex align-items-center">
                          <Link
                            href={`/admin/users/admins/${item.id}`}
                            className="me-4"
                          >
                      ...
                      <td style={{ width: 80 }}>
                        ...
                        >
                          <Link href={`/admin/users/admins/${item.id}`}>
                            <svg
